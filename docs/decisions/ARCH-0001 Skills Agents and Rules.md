---
title: Skills, Agents, and Rules
description: Three artifact types aligned with Claude Code's extension model for capabilities, personas, and constraints
type: adr
