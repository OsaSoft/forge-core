...
- [ADR 0013 Platform-Specific Companion Files](0013%20Platform-Specific%20Companion%20Files.md): skills use companion files for derived-specific content
- [ADR 0012 Rules as Shared Ecosystem Conventions](0012%20Rules%20as%20Shared%20Ecosystem%20Conventions.md): rules are module-delivered, installed by `make install`
