...
`bin/` is flat — files directly inside are added to the run_shell_command tool's PATH ([plugins reference][1]). No subdirectory recursion. Use extensionless names with shebangs and `chmod +x`.
