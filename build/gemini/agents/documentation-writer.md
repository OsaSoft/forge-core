...
2. **Concrete examples early** — are actual outputs, terminal blocks, or file contents shown in the first 3 sections? read_fileers need to see what this looks like before they'll invest in understanding how it works.
