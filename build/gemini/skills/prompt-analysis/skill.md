...
|----------------------------------|-----------------|-------------------------------------------|
| "scan", "audit", "check", "all" | Scan            | run_shell_command all subskills on a module             |
...
run_shell_command all static subskills (Provenance + Targeting + Staleness) on every rule in a module:
