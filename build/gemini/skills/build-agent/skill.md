...
- No abbreviations: `Documentationwrite_filer` not `Docwrite_filer`
...
4. What tools does it need? (read_file-only? Full access?)
...
### Step 4: write_file the agent file
...
### Step 1: read_file the agent file
...
run_shell_command the Validate workflow checklist against every agent. Report:
