...
claude:                               # merged into installed SKILL.md frontmatter
    ...
    allowed-tools: read_file, grep_search, glob   # tools usable without permission
...
### Step 2: write_file the SKILL.md
...
write_file the SKILL.md using the write_file tool.
...
### Step 1: read_file the target skill

read_file the SKILL.md file.
