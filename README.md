...
ADRs use [structured-madr][6] frontmatter with forge extensions. Validate with `python3 skills/ArchitectureDecision/validate-adr.py templates/forge-adr.json docs/decisions/`.
